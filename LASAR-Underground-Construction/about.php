<?php require('navbar.php');?>
    ...
    <div class="row container">
        ...
        <ul style="padding-left: 20px;">
            ...
            <li>Sewer &amp; Storm Drain Lines</li>
            <li>Placement of Power</li>
            <li>CATV</li>
